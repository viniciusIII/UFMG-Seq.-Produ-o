...
Funções para posicionar nós e desenhar conexões
Cores: verde para solução ótima, vermelho para podado, azul para explorado
Facilita compreensão da busca e da eficiência da poda
...
Importância de lower bound eficiente e poda para viabilidade do Branch and Bound
Visualização ajuda a entender o espaço de busca e a efetividade da poda
Relaxação do problema de transporte é fundamental para desempenho
